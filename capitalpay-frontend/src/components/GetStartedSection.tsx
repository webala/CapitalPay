    ...
    <section className="relative py-20 bg-gradient-to-b from-secondary/30 to-background">
      ...
      <div className="relative container mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-lg text-muted-foreground">
                Experience faster and smarter transactions, advanced payroll and many more amazing services today.
              </p>
            </div>
            ...
            <div className="space-y-6">
              {steps.map((step, index) => (
                <Card key={index} className="p-6 bg-gradient-card border-border/50 hover:shadow-glow-primary/20 transition-all duration-300">
          ...
          <div className="relative">
            <Card className="aspect-video bg-gradient-card border-border/50 flex items-center justify-center group hover:shadow-glow-primary/20 transition-all duration-300">
              <Button 
                variant="ghost" 
                size="lg"
            ...
            <p className="text-center text-muted-foreground mt-4">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, do exercitation exercitation sed do magna commodo. Lorem elit
            </p>
          </div>
        </div>
      </div>
