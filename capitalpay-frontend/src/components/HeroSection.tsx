...
const HeroSection = () => {
  return (
    <section className="relative min-h-screen bg-gradient-hero overflow-hidden">
      ...
      <div className="relative container mx-auto px-4  pb-20 max-w-7xl ">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left space-y-8">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight bg-gradient-to-r from-[#C6F1F7] via-[#F983E9] via-[#B877FF] to-[#C2E9CD] bg-clip-text text-transparent">
              ...
              <br />
              local <span className="text-accent">payments</span>
            </h1>

            <p className="text-lg md:text-xl text-muted-foreground max-w-2xl">
              Welcome to Capital Pay International.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <Button
                variant="cta"
                size="lg"
                className="rounded-3xl text-sm uppercase md:w-[400px] bg-gradient-to-b from-[#892887] via-[#E94258] via-[#F27224] to-[#F27224] hover:shadow-lg transition-all duration-300"
              >
              ...
              <Button
                variant="hero"
                size="lg"
                className="rounded-3xl text-sm uppercase md:w-[400px] text-white"
              >
               Discover personal options
              </Button>
            </div>
          </div>
          ...
          <div className="relative flex justify-center lg:justify-end">
            <div className="relative">
              <img
                ...
                className="w-80 md:w-96 xl:w-full h-auto drop-shadow-2xl transform hover:scale-105 transition-transform duration-300"
              />
              {/* Floating Elements */}
